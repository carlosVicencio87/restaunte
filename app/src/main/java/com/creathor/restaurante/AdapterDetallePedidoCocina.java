...
public class AdapterDetallePedidoCocina  extends RecyclerView.Adapter<AdapterDetallePedidoCocina.ViewHolderRecycler>{
    private ArrayList<ListaPedidoContenidoCocina> detalleRecycler;
    AdapterDetallePedidoCocina.ViewHolderRecycler viewholderDetallePedidos;
    private  RecyclerView recyclerView;
    private Context context;
    private String id,nombre,cantidad,total,precio2,extra,nota_mesero,estatus,mecero_asignado,fecha_entrega,fecha_final;
    private TextView aceptar_pedido;
    private AdapterDetallePedidoCocina activity;
    private LinearLayout caja_mecero_asignado;


    public AdapterDetallePedidoCocina(ArrayList<ListaPedidoContenidoCocina> pedidosrecycler )
    {
        this.detalleRecycler =pedidosrecycler;
    }
    @Override
    public AdapterDetallePedidoCocina.ViewHolderRecycler onCreateViewHolder(ViewGroup parent, int viewType) {
        View vista = LayoutInflater.from(parent.getContext()).inflate(R.layout.item6,parent,false);
        context=parent.getContext();
        vista.setFocusable(true);
        return new AdapterDetallePedidoCocina.ViewHolderRecycler(vista);

    }

    @Override
    public void onBindViewHolder(@NonNull AdapterDetallePedidoCocina.ViewHolderRecycler holder, int position) {
        ...
        estatus=detalleRecycler.get(position).getEstatus();
    ...
    public class ViewHolderRecycler extends RecyclerView.ViewHolder {
        TextView id_food,mes,comand,price,date_star,mecer_asigned,date_entrega,date_end,acept_pedido,rech_pedido
                ,name,details,price2,extr,note_meser,totl,status;
