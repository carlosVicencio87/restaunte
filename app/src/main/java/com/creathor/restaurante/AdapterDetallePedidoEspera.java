...
public class AdapterDetallePedidoEspera  extends RecyclerView.Adapter<AdapterDetallePedidoEspera.ViewHolderRecycler>{
    private ArrayList<ListaPedidosRecycler> detalleRecycler;
    AdapterDetallePedidoEspera.ViewHolderRecycler viewholderDetallePedidos;
    ...
    private AdapterDetallePedidoEspera activity;
    private LinearLayout caja_mecero_asignado;


    public AdapterDetallePedidoEspera(ArrayList<ListaPedidosRecycler> pedidosrecycler )
    {
        this.detalleRecycler =pedidosrecycler;
    }
    @Override
    public AdapterDetallePedidoEspera.ViewHolderRecycler onCreateViewHolder(ViewGroup parent, int viewType) {
        View vista = LayoutInflater.from(parent.getContext()).inflate(R.layout.item4,parent,false);
        context=parent.getContext();
        vista.setFocusable(true);
        return new AdapterDetallePedidoEspera.ViewHolderRecycler(vista);

    }

    @Override
    public void onBindViewHolder(@NonNull AdapterDetallePedidoEspera.ViewHolderRecycler holder, int position) {
