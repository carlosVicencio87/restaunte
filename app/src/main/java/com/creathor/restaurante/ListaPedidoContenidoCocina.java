...
public class ListaPedidoContenidoCocina extends AppCompatActivity {

    private String id,mesa,comanda,precio,fecha_ingreso,fecha_entrega,fecha_final,
            mecero_asignado,id_mesero,contenido,nombre,cantidad,total,precio2,extras,nota_mesero,estado,estatus;
    public String getId() {
        return id;
    }
   ...
   /* public void setFecha_entrega(String fecha_entrega) { this.fecha_entrega = fecha_entrega;}
    ...
    public ListaPedidoContenidoCocina(String name, String cant, String totl,String price2,String extr,String note_meser,
                                String id_food,
                                String mecer_asigned,String id_meser,String status){
