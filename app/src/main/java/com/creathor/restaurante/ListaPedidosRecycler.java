...
public class ListaPedidosRecycler extends AppCompatActivity {
    ...
    private String id,mesa,comanda,precio,fecha_ingreso,fecha_entrega,fecha_final, mecero_asignado,id_mesero,contenido,nombre,cantidad,total,precio2,extras,nota_mesero;
   ...
   /* public void setFecha_entrega(String fecha_entrega) { this.fecha_entrega = fecha_entrega;}
    ...
    public ListaPedidosRecycler(String id_food, String mes,
                                String comand, String price, String date_star,
                                String mecer_asigned,String id_meser,String content,
                                String name, String cant, String totl,
                                String price2,String extr,String note_meser){
